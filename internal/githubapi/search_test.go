...
func TestSearchRepositoriesEncodesQuery(t *testing.T) {
	...
	rest := &fakeRESTClient{responses: map[string]string{
		path: `{"items":[{"full_name":"docker/build-push-action","description":"Build images","stargazers_count":7100,"html_url":"https://github.com/docker/build-push-action"},{"full_name":"owner/undocumented","description":null,"stargazers_count":1,"html_url":"https://github.com/owner/undocumented"}]}`,
	}}
	...
	if results[0].Description == nil || *results[0].Description != "Build images" || results[1].Description != nil {
